...
INSERT INTO "new_Article" ("categoryId", "code", "designation", "diameter", "fluid", "groupArticleId", "id", "image", "length", "lotNumber", "name", "operatingPressure", "purchasePrice", "quantity", "referenceId", "sellingPrice", "stallId", "supplierId", "ticketId", "type", "unitPrice", "warehouseId") SELECT "categoryId", "code", "designation", "diameter", "fluid", "groupArticleId", "id", "image", "length", "lotNumber", "name", "operatingPressure", "purchasePrice", "quantity", "referenceId", "sellingPrice", "stallId", "supplierId", "ticketId", "type", "unitPrice", "warehouseId" FROM "Article";
DROP TABLE "Article";
...
INSERT INTO "new_Comment" ("creadtedAt", "id", "message", "updatedAt") SELECT "creadtedAt", "id", "message", "updatedAt" FROM "Comment";
DROP TABLE "Comment";
